...
func (x *RequestHeader) GetUuid() string {
	if x != nil {
		return x.Uuid
	}
	return ""
...
type ResponseHeader struct {
	...
	Error *data.Error `protobuf:"bytes,1,opt,name=error,proto3" json:"error,omitempty"` /// エラー
}
...
func (x *ResponseHeader) GetError() *data.Error {
	if x != nil {
		return x.Error
	}
	return nil
...
var file_proto_api_api_proto_rawDesc = []byte{
	...
	0x1a, 0x16, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x64, 0x61, 0x74, 0x61, 0x2f, 0x65, 0x72, 0x72,
	0x6f, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x23, 0x0a, 0x0d, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x12, 0x12, 0x0a, 0x04, 0x75, 0x75, 0x69,
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x75, 0x75, 0x69, 0x64, 0x22, 0x39, 0x0a,
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x45, 0x72, 0x72, 0x6f,
...
var file_proto_api_api_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_proto_api_api_proto_goTypes = []interface{}{
	(*RequestHeader)(nil),  // 0: proto.api.RequestHeader
	(*ResponseHeader)(nil), // 1: proto.api.ResponseHeader
	(*data.Error)(nil),     // 2: proto.data.Error
}
var file_proto_api_api_proto_depIdxs = []int32{
	2, // 0: proto.api.ResponseHeader.error:type_name -> proto.data.Error
